...
public class StickerController {
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "403", description = "등록 권한 없음 (아카이브 소유자가 아님)", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
            ...
            @ApiResponse(responseCode = "409", description = "해당 날짜에 이미 스티커가 존재합니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "404", description = "존재하지 않는 스티커입니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class))),
            @ApiResponse(responseCode = "409", description = "수정하려는 날짜에 이미 다른 스티커가 존재합니다.", content = @Content(schema = @Schema(implementation = ErrorResponse.class)))
    })
