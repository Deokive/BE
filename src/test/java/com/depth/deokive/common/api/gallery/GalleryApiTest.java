...
class GalleryApiTest {
    ...
    class ReadGallery {
        ...
        // Given: UserC(타인) 혹은 Anonymous
        // When: GET /api/v1/gallery/{publicArchiveId}?page=0&size=10
        // Then: 200 OK
        // Then: content 리스트에 썸네일/원본 URL 포함 확인
        ...
        /** SCENE 12. 페이지네이션 검증 */
        // Given: UserA 토큰, Public Archive (이미지 5개 가정)
        // When: GET ...?page=0&size=2
        // Then: 200 OK, totalElements=5, content.size=2 확인
    ...
    class DeleteGallery {
        ...
        // Then: **중요 check** -> 실제 Archive2의 GalleryID가 삭제되지 않고 살아있어야 함.
